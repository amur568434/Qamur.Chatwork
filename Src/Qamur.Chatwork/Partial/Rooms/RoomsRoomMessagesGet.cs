// <copyright file="RoomsRoomMessagesGet.cs" company="Kohei Oizumi">
...
namespace Qamur.Chatwork
{
    ...
    using DataType = System.Collections.Generic.IReadOnlyCollection<Qamur.Chatwork.Data.MessageData>;
    using ParametersType = Qamur.Chatwork.Parameters.MessagesParameters;
    ...
    public partial class ChatworkClient
    {
        ...
        public static ResponseData<DataType> GetRoomMessages(string token, long roomId, ParametersType parameters = null)
        {
        ...
        /// <param name="parameters">The options.</param>
        /// <returns>The response data.</returns>
        public static async Task<ResponseData<DataType>> GetRoomMessagesAsync(string token, long roomId, ParametersType parameters = null)
        {
            var path = string.Format(CultureInfo.InvariantCulture, Path.RoomMessages, roomId);
        ...
        /// <param name="roomId">The chat room id.</param>
        /// <param name="parameters">The options.</param>
        public async void GetRoomMessagesAsync(Action<ResponseData<DataType>> callback, long roomId, ParametersType parameters = null)
        {
            var path = string.Format(CultureInfo.InvariantCulture, Path.RoomMessages, roomId);
